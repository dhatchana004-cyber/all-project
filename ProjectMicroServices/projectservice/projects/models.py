...
class Project(models.Model):
    ...
    created_by = models.IntegerField()
    skip_supervisory = models.BooleanField(default=False)
    checklist_repoetory= models.BooleanField(default=False)
    maker_to_chechker=models.BooleanField(default=False)
...
class Purpose(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['project'], condition=Q(is_current=True), name='unique_current_purpose_per_project')
        ]
