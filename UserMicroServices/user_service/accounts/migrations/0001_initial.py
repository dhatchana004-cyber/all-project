...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('SUPERVISOR', 'Supervisor'), ('CHECKER', 'Checker'), ('MAKER', 'Maker'), ('INSPECTOR', 'Inspector')], max_length=50)),
                ('assigned_at', models.DateTimeField(auto_now_add=True)),
                ('user_access', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='roles', to='accounts.useraccess')),
            ],
            options={
